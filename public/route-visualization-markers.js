...
(function attachRouteVisualizationMarkers(root, factory) {
    ...
    function createEndpointMarkers(routeNodes, projection) {
        ...
        return [
            createMarker("start", sharedLogicalNode
            ...
            createMarker("end", sharedLogicalNode
    ...
    function createPreviewMarkers(previewSelection, projection) {
        ...
        if (previewSelection?.startNode) {
            ...
            previewMarkers.push(createMarker("preview-start", point, {
                label: "Start",
                logicalPoint: point,
        ...
        if (previewSelection?.endNode) {
            ...
            previewMarkers.push(createMarker("preview-end", point, {
                label: "End",
                logicalPoint: point,
